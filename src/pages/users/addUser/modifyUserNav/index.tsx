    ...
    <>
      ...
      <Dialog open={positiveOpen}>
        ...
        <Dialog.CustomContent>
          ...
          >
            Are you sure you want to create a new account with the provided
            information?
          </Typography>
        </Dialog.CustomContent>
        <Dialog.Actions>
      ...
      >
        <Typography group="input" variant="text" token={{ textAlign: "left" }}>
          Are you sure you want to clear your changes? Any unsaved data will be
          lost.
        </Typography>
      </CustomDialog>
      <NavActionsComponent
      ...
      >
        <Typography group="input" variant="text" token={{ textAlign: "left" }}>
          Are you sure you want to update the account with the provided
          information?
        </Typography>
      </CustomDialog>
      <CustomDialog
