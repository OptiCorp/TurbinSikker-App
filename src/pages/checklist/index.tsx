            ...
            <Tabs.List>
              <Tabs.Tab
                ...
                style={{
                  ...
                  backgroundColor:
                    activeTab === 0 ? COLORS.primary : COLORS.frostyGray,
                }}
              >
                <> {isLeader ? "My checklist" : "Incomming checklists"}</>
              </Tabs.Tab>
              <Tabs.Tab
                as={Link}
                to="/Checklists"
                style={{
                  ...
                  color: COLORS.black,
                  backgroundColor:
                    activeTab === 1 ? COLORS.primary : COLORS.frostyGray,
                }}
              >
                <> {isLeader ? "In progress" : "Outgoing checklists"}</>
              </Tabs.Tab>
              {isLeader ? (
                <Tabs.Tab
                  as={Link}
                  ...
                  style={{
                    ...
                    color: COLORS.black,
                    backgroundColor:
                      activeTab === 2 ? COLORS.primary : COLORS.frostyGray,
                  }}
                >
                  For review
                </Tabs.Tab>
